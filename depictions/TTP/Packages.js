...
$(document).ready(function () {
    ...
    if (!dPackage) {
        $(".package-error").text("Không thể tải dữ liệu").css("display", "block");
    ...
    $.getJSON("packages/" + dPackage + ".json", function (data) {
        ...
        if (typeof currentVersion === 'undefined' &&
            ...
            $(".version-check").css("color", "#ff6600");
        } else {
            // Compare versions
            var result = "";
            ...
            if (supported) {
                ...
                result += " &#x1F914;";
                $(".panel-body.version-check").css("background-color", "#282828");
            }
            $(".version-check").html(result);
        }
        ...
        var extra = {
            "<img class=\"icon\" src=\"icons/twitter.png\"><span>Find me on Twitter (@Tamph0ng)</span>": "https://mobile.twitter.com/TamPh0ng",
            "<img class=\"icon\" src=\"Icons/Email.png\"><span>Send me an email</span>": "mailto:truongtamphong686@gmail.com",
            "<img class=\"icon\" src=\"Icons/like.png\"><span>Buy me a &#x1F37A; via <span style=\"font-style:italic;font-weight:bold;\"><span style=\"color:#253b80;\">Pay</span><span style=\"color:#419bd7;\">Pal</strong></span></span>": "https://www.paypal.me/truongtamphong"
        };
        $.extend(links, extra);
